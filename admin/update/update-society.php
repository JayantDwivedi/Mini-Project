...
<body>
    <form action="" method="GET">
        ...
        <label for="">Flats <i class="fa fa-calendar" aria-hidden="true"></i></label>
        <input type="numbers" name="flats" value="<?php echo $_GET['fl']; ?>"><br></br>
...
if (isset($_GET['b1'])) {
    ...
    if ($name != "" && $mobile != "" && $email != "" && $address != "" && $time != "" && $date != "" && $comments != "" && $flat != "") {
        ...
        if ($data) {
            echo "<p style='color:green'>Record Updated Succesfully <a href='http://localhost/Mini-Project/admin/society-admin.php'>Click this to see updated Records</a>";
        } else {
