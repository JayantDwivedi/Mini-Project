...
<body>
    <form action="" method="GET">
        ...
        <label for="">Area <i class="fa fa-calendar" aria-hidden="true"></i></label>
        <input type="text" name="area" value="<?php echo $_GET['ar']; ?>"><br></br>
...
if (isset($_GET['b1'])) {
    ...
    if ($name != "" && $mobile != "" && $email != "" && $address != "" && $time != "" && $date != "" && $comments != "" && $area != "") {
        ...
        if ($data) {
            echo "<p style='color:green'>Record Updated Succesfully <a href='http://localhost/Mini-Project/admin/office-admin.php'>Click this to see updated Records</a>";
        } else {
