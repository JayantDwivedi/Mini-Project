...
<body>
    <form action="" method="GET">
        ...
        <input type="text" name="rooms" value="<?php echo $_GET['rms']; ?>"><br></br>
...
if (isset($_GET['b1'])) {
    ...
    if ($name != "" && $mobile != "" && $email != "" && $address != "" && $time != "" && $date != "" && $comments != "" && $rooms != "") {
        ...
        if ($data) {
            echo "<p style='color:green'>Record Updated Succesfully <a href='http://localhost/Mini-Project/admin/hotel-admin.php'>Click this to see updated Records</a>";
        } else {
