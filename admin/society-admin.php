    ...
    <div class="row panel">
        ...
        <div class="col-lg-8">
            <section class="content">
                ...
                $query = "SELECT * FROM `societyservice`";   // query for select all the items from database
                ...
                <tr>
                  ...
                  <td><a href='delete/delete-society.php?rn=$result[mobile]' onclick = 'return DeleteRecord()'><i style='color:red;font-size:24px;' class='fa fa-trash'></i></a></h4>
                  <a href='update/update-society.php?rn=$result[name]&nm=$result[mobile]&cl=$result[email]&ad=$result[address]&tm=$result[time]&dt=$result[date]&cm=$result[comment]&fl=$result[flats]'><i style='color:blue;font-size:24px;margin-left:25px;' class='fa fa-pencil'></i></a></td>
                </tr>
                ";
                    }
                    ?>
