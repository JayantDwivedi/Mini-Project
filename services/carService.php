...
<head>
    ...
    <title>SANSERV | Services | Car Service</title>
            ...
            <div class="col-lg-10 service-tag">
                ...
                <div class="row">
                    <div class="col-lg-6 form-sec">
                        <div id="formBox">
                            <div>
                                <h2 class="text-center head">CAR SERVICE FORM</h2>
                            </div>
                                            ...
                                            if (isset($_POST['b1'])) {
                                                ...
                                                if ($email == "") {
                                                    ...
                                                    if(!(preg_match($pattern,$email))) {
                                                       echo "<small>Enter a valid Email</small>"; 
                                                    }
                                                }
                    ...
                    <div class="col-lg-5 img-sec">
                        ...
                        <img src="../images/carservice.jpg" alt="" class="img-fluid mt-5 pt-5" id="image1">
...
if (isset($_POST['b1'])) {
    ...
    if ($name != "" && $email != "" && $mob != "" && $address != "" && $ts != "" && $ds != "" && $comments != "") {
        $query = "insert into carservice (name,email,mobile,address,time,date,comment) values('$name','$email','$mob','$address','$ts','$ds','$comments')";
