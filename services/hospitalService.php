            ...
            <div class="col-lg-2 menu-bar">
                <div id="navigationBox">
                    ...
                    <ul>
                        ...
                        <li class="py-4 my-4"><a href="socityService.html">Society Sanitization </a></li>
...
if (isset($_POST['b1'])) {
    ...
    if ($name != "" && $email != "" && $mob != "" && $address != "" && $ts != "" && $ds != "" && $comments != "") {
        $query = "insert into hospitalservice (name,email,mobile,address,time,date,comment) values('$name','$email','$mob','$address','$ts','$ds','$comments')";
