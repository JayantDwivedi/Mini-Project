...
<head>
    ...
    <title>SANSERV | Services | School Service</title>
            ...
            <div class="col-lg-10 service-tag">
                ...
                <div class="row">
                    <div class="col-lg-6 form-sec">
                        <div id="formBox">
                            <div>
                                <h2 class="text-center head">SCHOOL SERVICE FORM</h2>
                            </div>
                            ...
                            <div>
                                <form action="" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="rooms" autocomplete="off" class="form-control" placeholder="Enter Number of Rooms">
                                    </div>
                    ...
                    <div class="col-lg-5 img-sec">
                        ...
                        <img src="../images/schoolservice.jpg" alt="" class="img-fluid mt-5 pt-5" id="image1">
...
if (isset($_POST['b1'])) {
    ...
    if ($name != "" && $email != "" && $mob != "" && $address != "" && $ts != "" && $ds != "" && $comments != "") {
        $query = "insert into schoolservice (name,email,mobile,address,time,date,rooms,comment) values('$name','$email','$mob','$address','$ts','$ds','$rooms','$comments')";
