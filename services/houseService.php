            ...
            <div class="col-lg-10 service-tag">
                ...
                <div class="row">
                    <div class="col-lg-6 form-sec">
                        <div id="formBox">
                            <div>
                                <h2 class="text-center head">HOUSE SERVICE FORM</h2>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                            if (isset($_POST['b1'])) {
                                                ...
                                                $pattern = "/^[A-Za-z]+$/";
                                                if ($name == "") {
                                                    echo "<small>Enter a valid Name</small>";
                                                }
                                                else {
                                            ...
                                            if (isset($_POST['b1'])) {
                                                ...
                                                if ($email == "") {
                                                    ...
                                                    if(!(preg_match($pattern,$email))) {
                                                       echo "<small>Enter vaid Email</small>"; 
                                                    }
                                                }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                            if (isset($_POST['b1'])) {
                                                ...
                                                $pattern = "/^[6-9]\d{9}$/";
                                                if ($mobile == "") {
                                                    echo "<small>Enter valid Mobile no with 10 digits</small>";
                                                }
                                                else {
                                                    if(!(preg_match($pattern,$mobile))) {
                                                       echo "<small>Enter valid mobile no with proper digits</small>"; 
                                                    }
                                                }
