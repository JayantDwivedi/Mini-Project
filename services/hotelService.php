...
<head>
    ...
    <title>SANSERV | Services | Hotel Service</title>
            ...
            <div class="col-lg-2 menu-bar">
                <div id="navigationBox">
                    ...
                    <ul>
                        ...
                        <li class="py-4 my-4"><a href="officeService.html">Society Sanitization </a></li>
                        <li class="py-4 my-4"><a href="wareHouseService.html">Warehouse Sanitization </a></li>
            ...
            <div class="col-lg-10 service-tag">
                ...
                <div class="row">
                    <div class="col-lg-6 form-sec">
                        <div id="formBox">
                            <div>
                                <h2 class="text-center">HOTEL SERVICE FORM</h2>
                            </div>
